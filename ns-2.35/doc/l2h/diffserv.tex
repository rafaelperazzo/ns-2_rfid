\chapter{Differentiated Services Module in \emph{ns}}
\label{chap:diffserv}
...
Class~{\tt dsREDQueue} contains a data structure known as 
...
Class~{\tt PolicyClassifier} also contains a Policer Table to 
